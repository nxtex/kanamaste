...
const products = [
  ...
  },
  {
    ...
    longDescription: "Notre huile Full Spectrum 10% est extraite au CO₂ supercritique pour préserver la totalité des cannabinoïdes, terpènes et flavonoïdes naturels de la plante. L'effet d'entourage amplifie les bienfaits du CBD, offrant une action plus complète et harmonieuse. Base MCT biologique, THC < 0.2%.",
    intensity: 2,
  ...
  },
  {
    ...
    longDescription: "Le Charas CBD est élaboré selon la méthode himalayenne ancestrale — roulé à la main sur les têtes fraîches de chanvre CBD. Cette technique préserve les terpènes les plus volatils, donnant un profil aromatique incomparable : rose, bois, épices douces et cèdre.",
    intensity: 3,
  ...
  },
  {
    ...
    category: 'Huile',
    description: "Formule nuit: CBD 15%, mélatonine et lavande. Retrouvez un sommeil naturel.",
