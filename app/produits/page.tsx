...
const products = [
  ...
  },
  {
    ...
    longDescription: "La Northern Lights CBD est une indica pure aux arômes doux de pin, de terre et de sucre. Son profil terpénique dominé par le linalool et le myrcène en fait une alliée de choix contre les tensions musculaires et le stress du quotidien. Fleurs cultivées en intérieur, denses et généreusement résineuses.",
    intensity: 5,
          ...
          <div style={{ maxWidth: 'var(--content-wide)', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-end', gap: 'var(--space-4)' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
                ...
                <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--text-2xl)', fontWeight: 900, lineHeight: 1.05, color: 'var(--color-text)' }}>
                ...
                <p style={{ fontSize: 'var(--text-base)', color: 'var(--color-text-muted)', maxWidth: '52ch', lineHeight: 1.6 }}>
                  Fleurs, r&eacute;sines et huiles CBD s&eacute;lectionn&eacute;es pour leur qualit&eacute; et leurs ar&ocirc;mes d&apos;exception. Tous nos produits sont test&eacute;s en laboratoire ind&eacute;pendant.
                </p>
              </div>
